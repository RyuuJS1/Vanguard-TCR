...
if __name__ == '__main__':
    ...
    print("=" * 50)
    print("      VANGUARD TCR - SERVER STATUS")
    print("=" * 50)
    print(f"[*] PIN DE ACCESO:    \033[1;32m{PIN_ACCESO}\033[0m")
    print(f"[*] IP PARA LA WEB:   \033[1;36m{ip_pub}\033[0m")
    print("-" * 50)
    print("[!] CONFIGURACIÓN REQUERIDA:")
    print("    1. En tu Router: Redirige el puerto 5000 a tu IP Local.")
    print("    2. En el Navegador: Acepta el certificado en la IP pública.")
    print("=" * 50)
    
    # El ssl_context='adhoc' es vital para que sea HTTPS
